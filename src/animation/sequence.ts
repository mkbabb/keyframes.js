...
import { SequenceEventBus } from "./sequence-events";
import type {
    SequenceEntry,
    SequenceEvent,
...
// co-located `./sequence-events` module (L.WZ decomposition). Re-export the moved
// TYPES THROUGH this file so the barrel's `export type { … } from "./sequence"`
// keeps resolving — the published surface is unchanged.
export type {
    SequenceEntry,
    SequenceEvent,
    SequenceSegmentSubscriber,
