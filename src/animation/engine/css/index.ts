 ...
 *
 * The `CSSKeyframesAnimation` entry-point subclass (`animation.ts`) + its
 ...
 * helpers stay INTERNAL — `animation.ts` imports them DIRECTLY (`./metadata`),
 ...
 */
export { CSSKeyframesAnimation } from "./animation";
