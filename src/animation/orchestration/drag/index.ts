 ...
 * (`draggable.ts`) and the 2-D sugar `drag2D` (`2d.ts`). The barrel owns the
 * merged surface, replacing the retired flat-sibling re-export relay — `draggable.ts`
 * imports nothing from `2d.ts`; `2d.ts` imports only `Draggable`.
...
export { drag2D } from "./2d";
export type { Drag2DHandle } from "./2d";
