/**
 * orchestration/timeline/timeline.ts — the progress-driver family (S.B4 — carved
 * out of the `timeline/index.ts` barrel so the barrel is a pure re-export surface
 * like every other zone; r3 F4 / a02).
 *
 * `Timeline` (abstract) + `KeyframesScrollTimeline` (the JS scroll sampler) +
...
export interface TimelineOptions {
     ...
     * new KeyframesScrollTimeline({ easing });
     * ```
     */
