<template>
    <div class="grid gap-2">
        ...
        <div class="grid grid-cols-[auto_1fr] items-center gap-x-3 gap-y-1.5">
                <label class="font-mono text-2xs text-muted-foreground">name</label>
                <Input
                ...
                <!-- Position -->
                <label class="font-mono text-2xs text-muted-foreground">x</label>
                <Input
                    type="number"
                ...
                <label class="font-mono text-2xs text-muted-foreground">y</label>
                <Input
                    type="number"
                ...
                <!-- Size -->
                <label class="font-mono text-2xs text-muted-foreground">width</label>
                <Input
                    type="number"
                ...
                <label class="font-mono text-2xs text-muted-foreground">height</label>
                <Input
                    type="number"
                ...
                <!-- Rotation -->
                <label class="font-mono text-2xs text-muted-foreground">rotation</label>
                <div class="flex items-center gap-2">
                    ...
                    />
                    <span class="font-mono text-2xs text-muted-foreground w-8 text-right">{{ Math.round(asset.transform.rotation) }}°</span>
                </div>

                <!-- Kind-specific properties -->
                <template v-if="asset.kind !== 'text' && asset.kind !== 'svg'">
                    <label class="font-mono text-2xs text-muted-foreground">bg color</label>
                    <Input
                ...
                <template v-if="asset.kind === 'rectangle' || asset.kind === 'circle'">
                    <label class="font-mono text-2xs text-muted-foreground">radius</label>
                    <Input
                        type="number"
                ...
                <template v-if="asset.kind === 'text'">
                    <label class="font-mono text-2xs text-muted-foreground">text</label>
                    <Input
                    ...
                    <label class="font-mono text-2xs text-muted-foreground">font size</label>
                    <Input
                        type="number"
                    ...
                    <label class="font-mono text-2xs text-muted-foreground">font</label>
                    <Input
                    ...
                    <label class="font-mono text-2xs text-muted-foreground">color</label>
                    <Input
                ...
                <template v-if="animationNames && animationNames.length > 0">
                    <label class="font-mono text-2xs text-muted-foreground">animation</label>
                    <Select
