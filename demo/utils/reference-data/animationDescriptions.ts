...
// from these entries, same keys, same insertion order.
type BezierQuad = [number, number, number, number];

export const NAMED_EASING_BEZIER_ENTRIES: readonly (readonly [
    EasingName,
    BezierQuad,
])[] = [
...
export const NAMED_EASING_BEZIER: Record<string, BezierQuad> =
    Object.fromEntries(NAMED_EASING_BEZIER_ENTRIES);
