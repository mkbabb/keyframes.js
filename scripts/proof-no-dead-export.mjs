...
const DEFERRED = [
    ...
    ["demo/@/components/custom/animation-transport/animationDescriptions.ts", "COLOR_SPACE_DESCRIPTIONS"],
    ["demo/@/components/custom/animation-transport/animationDescriptions.ts", "HUE_METHOD_DESCRIPTIONS"],
    ["demo/@/components/custom/animation-transport/composables/useAnimationGroupActions.ts", "UseAnimationGroupActionsDeps"],
    ["demo/@/components/custom/animation-transport/composables/useAnimationGroupActions.ts", "UseAnimationGroupActionsReturn"],
    ["demo/@/components/custom/animation-transport/composables/useAnimationGroupPlayback.ts", "AnimationGroupPlaybackEmit"],
    ["demo/@/components/custom/animation-transport/composables/useControlsKeyboardShortcuts.ts", "UseControlsKeyboardShortcutsDeps"],
    ["demo/@/components/custom/animation-transport/composables/usePaneRegister.ts", "UsePaneRegisterOptions"],
    ["demo/@/components/custom/animation-transport/composables/usePaneRegister.ts", "UsePaneRegisterReturn"],
    ["demo/@/components/custom/animation-transport/composables/usePlayActuation.ts", "PlayActuationHandlers"],
    ["demo/@/components/custom/animation-transport/composables/useScrollFade.ts", "UseScrollFadeOptions"],
    ["demo/@/components/custom/animation-transport/composables/useScrollFade.ts", "UseScrollFadeReturn"],
    ["demo/@/components/custom/animation-transport/composables/useSheetState.ts", "UseSheetStateOptions"],
    ["demo/@/components/custom/animation-transport/composables/useSheetState.ts", "UseSheetStateReturn"],
    ["demo/@/components/custom/animation-transport/controls/composables/useDragCapture.ts", "DragCaptureHandlers"],
    ["demo/@/components/custom/animation-transport/controls/composables/useKeyframesPaneReveal.ts", "UseKeyframesPaneRevealOptions"],
    ["demo/@/components/custom/animation-transport/controls/composables/useKeyframesPaneReveal.ts", "UseKeyframesPaneRevealReturn"],
    ["demo/@/components/custom/animation-transport/controls/composables/useSelectedControlSurface.ts", "UseSelectedControlSurfaceOptions"],
    ["demo/@/components/custom/animation-transport/controls/composables/useSelectedControlSurface.ts", "UseSelectedControlSurfaceReturn"],
