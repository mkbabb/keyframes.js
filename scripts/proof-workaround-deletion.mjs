...
const arms = [
    ...
    },
    {
        ...
        witness: {
            subpath: "demo/app/chrome/ChromeDock.vue",
            fileFilter: exact("demo/app/chrome/ChromeDock.vue"),
            pattern: /isAnyOpen/,
        },
    ...
    },
    {
        ...
        witness: {
            subpath: "demo/app/chrome/MbabbMenu.vue",
            fileFilter: exact("demo/app/chrome/MbabbMenu.vue"),
