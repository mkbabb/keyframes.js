#!/usr/bin/env node
/**
 * usability — the G.W11 live-Playwright observation (the three
 ...
 * `node scripts/observe/demo/usability.mjs`. The browser half serves the BUILT
...
if (failures.length > 0) {
    console.error(
        `\nusability observation — FAIL (${failures.length}): the demo carries a ` +
...
console.log(
    "\nusability observation — PASS: the live behaviors hold (G.W11) and the hero rides the " +
