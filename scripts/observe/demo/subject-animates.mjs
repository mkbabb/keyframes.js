#!/usr/bin/env node
/**
 * subject-animates — direct observation of the subject-write seam.
 *
 ...
 * Re-runnable:
 *   npm run build && KF_REQUIRE_BROWSER=1 node scripts/observe/demo/subject-animates.mjs
 */
