// Consumer-bundle boundary check — keyframes.js M.W9 / DM-25 (the "atlas" finding).
//
// THE GAP (the generalized atlas finding): the sibling boundary check bundles from SOURCE
...
try {
    const bundle = await rolldown({
        ...
        // the source-boundary check proves its graph grammar-free + externalizes it the same
    ...
    // (mirroring the source-boundary W97 allow-list) so the legitimate grammar-free
