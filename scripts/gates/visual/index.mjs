 ...
 *
 * ── USAGE ──────────────────────────────────────────────────────────────────────
 *   node scripts/gates/visual/index.mjs                    — GATE
 *   node scripts/gates/visual/index.mjs --capture-candidates
            ...
            if (failures.length > 0) {
                ...
                console.error(
                    ...
                    `  BLESSING token (docs/tranches/T/goldens/BLESSED.json) over the 14 CANDIDATE frames, each\n` +
                        ...
                        `  Capture the candidates: \`node scripts/gates/visual/index.mjs --capture-candidates\` (after \`npm run gh-pages\`).`,
                );
                process.exit(1);
            }
            console.log(
