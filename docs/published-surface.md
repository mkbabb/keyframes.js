...
| `KeyframesScrollTimeline` | LIGHT | manifest-only: L.W8 S4 PKG-3 — the canonical name of the JS scroll-progress sampler (renamed from `ScrollTimeline` to clear the `globalThis.ScrollTimeline` d.ts collision; `proof:pkg3-clean`). Same `Timeline` pipeline as the `ScrollTimeline` alias.                                                                                                                                                                                  |
| `ScrollTimeline`       | LIGHT | [README §Timeline](../README.md#timeline) — @deprecated PKG-3 backward-compat alias of `KeyframesScrollTimeline` (L.W8 S4)                                                                                                                                                                                                                                                                                                                  |
...
| Export                  | Tier  | Taught                                                                                                                                                     |
| ----------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `KeyframesAnimation`    | HEAVY | manifest-only: L.W8 S4 PKG-3 — the canonical name of the core engine class (renamed from `Animation` to clear the `globalThis.Animation` d.ts collision; `proof:pkg3-clean`). `CSSKeyframesAnimation` extends it.                                                            |
| `Animation`             | HEAVY | [README §Animation](../README.md#animation) — @deprecated PKG-3 backward-compat alias of `KeyframesAnimation` (L.W8 S4)                                     |
